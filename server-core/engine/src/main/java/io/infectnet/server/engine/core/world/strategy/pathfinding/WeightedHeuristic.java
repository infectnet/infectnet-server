...
/**
 * A heuristic function for the path finding algorithm, with bounded relaxation. Calculating the
 * estimated distance between two positions and scaling it up with the epsilon parameter. The main
 * purpose is to trade finding the optimal path to finding a good-enough path faster.
 */
