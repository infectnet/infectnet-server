...
public class ServiceModule {
  ...
  @Provides
  @Singleton
  public static ConverterService providesConverterService() {
  ...
  @Provides
  @Singleton
  public static TokenService providesTokenService(TokenStorage tokenStorage,
  ...
  @Provides
  @Singleton
  public static UserService providesUserService(UserStorage userStorage, TokenStorage tokenStorage,
                                                ConverterService converterService,
  ...
  @Provides
  @Singleton
  public static EncrypterService providesEncrypterService() {
